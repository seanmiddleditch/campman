    ...
    public render()
    {
        ...
        return (
            <div>
                ...
                <FormInput type='datetime-local' title='Adventure Time' name='created_at' value={adventure.created_at ? adventure.created_at.toISOString() : ''} disabled={!!this.state.saving} onChange={val => this._handleChange('created_at', new Date(val))}/>
