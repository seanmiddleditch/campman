        ...
        return (<div>
            ...
            <div className='form-group mb-2'>
                <div className='input-group'>
                    ...
                    <input type='text' className='form-control' value={this.state.page.slug} placeholder={EditWiki._makeSlug(this.state.page.title || '')} onChange={ev => this._handleChange('slug', ev.target.value)}/>
                </div>
            ...
            <div className='form-group mb-2'>
                <MarkEditor document={this.state.page.rawbody} onChange={doc => this._handleChange('rawbody', doc)} buttons={() => (
                    <div className='ml-sm-2 float-right'>
                        <DropButton className='btn-group mr-2' display={this.state.page.visibility}>
