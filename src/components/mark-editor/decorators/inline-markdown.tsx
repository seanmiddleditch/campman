...
import { findWithRegex, FindWithRegexCallback } from './helpers'

const STRONG_REGEX = /[*][*]([^*]+)[*][*]/g
const EM_REGEX = /[*]([^*]+)[*]($|[^*])/g
const UNDERLINE_REGEX = /_([^_]+)_/g

const inlineMarkdownStrategy = (regex: RegExp) => (contentBlock: ContentBlock, callback: FindWithRegexCallback, contentState: ContentState) => {
